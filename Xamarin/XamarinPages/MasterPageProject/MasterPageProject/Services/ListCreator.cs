...
namespace MasterPageProject.Services
{
    public class ListCreator
    {
        private static ObservableCollection<Car> carList;

        public static ObservableCollection<Car> CarList { get => carList; set => carList = value; }
